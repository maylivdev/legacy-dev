...
export const UNESCO_DOMAINS: UnescoDomain[] = [
  {
    id: 'oral_traditions',
    name_kk: 'Материалдық емес мәдени мұраның тасымалдағышы ретінде тілді қоса алғанда, пайымның дәстүрлері мен нысандары',
    name_ru: 'Устные традиции и формы выражения, включая язык в качестве носителя нематериального культурного наследия',
  ...
  {
    id: 'performing_arts', name_kk: 'Орындаушылық өнерлер', name_ru: 'Исполнительские искусства', name_en: 'Performing arts',
    description_kk: 'Музыка, би, театр', description_ru: 'Музыка, танцы, театр', description_en: 'Music, dance, theatre',
  },
  {
    id: 'social_practices',
    name_kk: 'Әдет-ғұрыптар, салт-жоралар, мейрамдар',
  ...
  {
    id: 'nature_knowledge',
    name_kk: 'Табиғат пен дүниеге қатысты білімдер мен әдет-ғұрыптар',
    name_ru: 'Знания и обычаи, относящиеся к природе и вселенной',
  ...
  {
    id: 'craftsmanship',
    name_kk: 'Дәстүрлі кәсіптермен байланысты білімдер және дағдылар',
    name_ru: 'Знания и навыки, связанные с традиционными ремёслами',
